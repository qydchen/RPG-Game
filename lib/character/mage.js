...
class Mage extends Character {
  ...
  spendPow(arcanePowerCost) {
    if (this.hasPow(arcanePowerCost)) {
      this.stat.arcanePower -= arcanePowerCost;
    } else {
      console.log('Not enough Arcane Power');
    }
  }

  hasPow(arcanePowerCost = 0) {
