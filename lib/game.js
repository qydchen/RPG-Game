...
// Ash.viewStats();
// Harry.viewStats();
Harry.learnSpell('fireBall');
// Harry.learnSpell('thunderBolt');
// Harry.learnSpell('earthQuake', 0);
Harry.learnSpell('cyclone');
// console.log(Harry.spellBook);
Harry.spellBook.fireBall(Ash);
Harry.spellBook.fireBall(Ash);
Harry.spellBook.fireBall(John);
// Harry.viewStats();
// Harry.spellBook.fireBall(Dave)
// Harry.viewStats();
// Harry.spellBook.earthQuake(Ash, John, Sly, Dave, Sly1, Sly2, Sly3, Sly4 );
