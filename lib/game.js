...
// Harry.cast('Fireball', Ash);
// Harry.viewStats();
// Harry.cast('Cyclone', Dave, John, Ash, Sly)
// Dave.viewStats();
// Dave.levelUp();
// Dave.viewStats();
...
// Dave.learn('Berserk');
// Dave.learn('Fury');
// Dave.learn('ShieldBash');
// Dave.equip(loot.dagger.papershiv, 'offHand')
// Dave.viewInventory();
// Dave.perform('Fury');
// Dave.viewStats();
// Dave.perform('Fury');
// Dave.viewStats();
// Dave.perform('ShieldBash', Sly);
// Dave.viewStats();
// Dave.viewStatus();
// Sly.learn('Pursuit');
...
// Sly.viewStats();
// Sly.perform('Pursuit', Dave);
// Sly.viewStats();
// Sly.perform('Blackjack', Dave);
// Sly.perform('Tonic');
...
// John.learn('CobraSting')
// John.equip(loot.sword.greatpapersword)
// John.viewStats();
