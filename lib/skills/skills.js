...
const { COM, SPL, MIX, SHLD, OFF, DEF, AOE, SIN, SELF, FIRE, ICE, WIND, SHOCK, PHYS, HOLY, DARK, GEN, SPE, NON } = _;
...
const HeroicStrike = new Skill('Heroic Strike', COM, OFF, SIN, PHYS, {}, GEN, 15, 1.1, 1, 0, null, {mainHand: true});
// a generator that increases defense by 1.5x hero level
const ShieldBlock = new Skill('Shield Block', COM, DEF, SELF, PHYS, {}, GEN, 15, 0, 0, 1.5, ['def'], {offHand: {subtype: 'shield'}});
// a spender that deals a massive strike to the enemy for 1.8x damage
const MortalStrike = new Skill('Mortal Strike', COM, OFF, SIN, PHYS, {}, SPE, 30, 1.8, 1, 0, null, {mainHand: true});
// a spender that slows the opponent and deals 0.5x damage
const Hamstring = new Skill('Hamstring', COM, OFF, SIN, PHYS, {SLOW: true}, SPE, 7, 0.5, 1, 0, null, {mainHand: true});
// a spender that deals 1x damage across all enemies
const Cleave = new Skill('Cleave', COM, OFF, AOE, PHYS, {}, SPE, 15, 1, 1, 0, null, {mainHand: true});
// a spender that increases the atk, def, spAtk, and maxHP of the party by 1x the warrior's level
const CommandingCry = new Skill('Commanding Cry', COM, DEF, AOE, PHYS, {}, SPE, 30, 0, 0, 1, ['atk', 'def', 'spAtk', 'maxHP']);
// generates 45 rage
const Fury = new Skill('Fury', COM, OFF, SELF, PHYS, {}, GEN, 45);
// a spender that deals BZK the user and increases attack by 5x
const Berserk = new Skill('Berserk', COM, DEF, SELF, FIRE, { BZK: true }, SPE, 50, 0, 0, 5, ['atk']);
// a spender that deals 1.1x damage plus the owners atk and def combined. paralyzes opponent
const ShieldBash = new Skill('Shield Bash', SHLD, OFF, SIN, PHYS, { PAR: true }, SPE, 30, 1.1, 1, 0, null, {offHand: {subtype: 'shield'}});
