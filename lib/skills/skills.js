...
// a finishing move that expends all combo points to buff atk and spd by 0.5x times the current level of the user
const BladeFlurry = new Skill('Blade Flurry', COM, DEF, SELF, WIND, {}, SPE, 0, 0, 0, 0.5, ['spd', 'atk'])
