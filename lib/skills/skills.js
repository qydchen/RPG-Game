...
const Harden = new Skill('Harden', COM, DEF, SELF, PHYS, {}, NON, 0, 0, 0, 1, ['def']);
// a self buff that adds 4x level modifier to the caster's spAtk
const ArcaneIntellect = new Skill('Arcane Intellect', SPL, DEF, SELF, PHYS, {}, NON, 0, 0, 0, 4, ['spAtk'])
// a self buff that adds 4x level modifier to the caster's atk
const HolyMight = new Skill('Holy Might', SPL, DEF, SELF, HOLY, {}, NON, 0, 0, 0, 4, ['atk']);
// a spender that damages opponents for 1.2x damage. modifier is based on the user's atk and spAtk combined
const Smite = new Skill('Smite', MIX, OFF, SIN, HOLY, {}, SPE, 1, 1.2, 1, 0)
...
const CobraShot = new Skill('Cobra Shot', COM, OFF, SIN, WIND, {}, GEN, 30, 1.0, 1, 0)
...
const FreezeTrap =  new Skill('FreezeTrap', COM, OFF, AOE, ICE, {FZN: true}, SPE, 50, 0, 0, 0)
