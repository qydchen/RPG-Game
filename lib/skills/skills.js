...
const AimedShot = new Skill('Aimed Shot', COM, OFF, SIN, PHYS, {}, SPE, 40, 1.3, 1, ['atk'])
// a spender that does damage and buffs def by 1x the level of character
const DeterringShot = new Skill('Deterring Shot', COM, OFF, SIN, PHYS, {}, SPE, 40, 1.3, 1, ['def'])
...
const BlastShot = new Skill('Blast Shot', COM, OFF, AOE, FIRE, {BURN: true, FZN: false}, SPE, 50, 1.2, 1)
...
const FreezeTrap =  new Skill('FreezeTrap', COM, OFF, AOE, ICE, {FZN: true), SPE, 50, 0, 1)
// a move that prevents an attack and returns 0.5x the damage back to the opponent
const Riposte = new Skill('Riposte', COM, DEF, SELF, PHYS, {}, NON, 0, 0.5, 0)
