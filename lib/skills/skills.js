...
const Generator = require('./skillFactory/generator');
const Spender = require('./skillFactory/spender');
const _ = require('./singletons')

const { COM, SPL, OFF, DEF, AOE, SIN, FIRE, ICE, SHOCK, PHYS, HOLY, DARK } = _;

const Fireball = new Generator('Fireball', SPL, OFF, SIN, FIRE, {BURN: true, FZN: false}, 10, 1.1);
