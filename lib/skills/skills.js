...
const AimedShot = new Skill('Aimed Shot', COM, OFF, SIN, PHYS, {}, SPE, 40, 1.2, 1, 2, ['atk'], bowReq);
// a spender that does damage and buffs def by 1x the level of character
const DeterringShot = new Skill('Deterring Shot', COM, OFF, SIN, PHYS, {}, SPE, 40, 1.2, 1, 2, ['def'], bowReq);
