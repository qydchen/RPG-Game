...
const Marksmanship = new Skill('Marksmanship', COM, DEF, SELF, WIND, {}, NON, 0, 0, 0, 3, ['atk']);
...
// a finishing move that expends all combo points to buff atk and spd by 0.7x times the current level of the user
const BladeFlurry = new Skill('Blade Flurry', COM, DEF, SELF, WIND, {}, SPE, 0, 0, 0, 0.7, ['spd', 'atk'])
