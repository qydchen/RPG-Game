...
const IceArmor = new Skill('Ice Armor', SPL, DEF, SELF, ICE, {}, NON, 0, 0, 0, 3, ['def']);
...
const MassHaste = new Skill('Mass Haste', SPL, DEF, AOE, WIND, {}, NON, 0, 0, 0, 2, ['spd'])
...
// a combat self buff that adds 2x level modifier to the performer's def
const Harden = new Skill('Harden', COM, DEF, SELF, PHYS, {}, NON, 0, 0, 0, 2, ['def']);
...
const AimedShot = new Skill('Aimed Shot', COM, OFF, SIN, PHYS, {}, SPE, 40, 1.2, 1, 2, ['atk'])
// a spender that does damage and buffs def by 1x the level of character
const DeterringShot = new Skill('Deterring Shot', COM, OFF, SIN, PHYS, {}, SPE, 40, 1.2, 1, 2, ['def'])
// a generator that does 1.1x multiplier damage
const ForceArrow = new Skill('Force Arrow', COM, OFF, SIN, WIND, {}, GEN, 30, 1.1, 1, 0)
// a spender that does AoE damage and burns all targets
const BlastShot = new Skill('Blast Shot', COM, OFF, AOE, FIRE, { BURN: true, FZN: false }, SPE, 50, 1.1, 1, 0)
// a spender that ignores armor and does 0.8x the damage of atk
const ExposingShot = new Skill('Exposing Shot', COM, OFF, SIN, DARK, {}, SPE, 40, 0.8, 0, 0)
// a generator that does damage and generates alot of focus
const SteadyShot = new Skill('Steady Shot', COM, OFF, SIN, PHYS, {}, GEN, 35, 1, 1, 0)
// a spender that paralyzes the opponent
const CobraSting = new Skill('Cobra Sting', COM, OFF, SIN, DARK, { PAR: true }, SPE, 35, 1, 1, 0)
// a spender that freezes every enemy in place
const FreezeTrap =  new Skill('Freeze Trap', COM, OFF, AOE, ICE, { FZN: true }, SPE, 50, 0, 0, 0)
// a massive self buff that adds 4x level multiplier to damage
const Marksmanship = new Skill('Marksmanship', COM, DEF, SELF, WIND, {}, NON, 0, 0, 0, 4, ['atk']);
