...
class Skill {
  constructor({name, type = COM, subtype = OFF, targetProp = SIN, element = PHYS, statuses = {}, skillType = NON, resource = 0, firMultiple = 0, secMultiple = 0, thirdMultiple = 0, buffs = null, req = null}) {
    this.name = name;
