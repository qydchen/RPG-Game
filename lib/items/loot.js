...
export const initMageInv = [cloth.clothcap, cloth.clotharmor, wand.paperwand, source.paperskull];
export const initHunterInv = [leather.leathercap, leather.leatherarmor, bow.paperbow];
export const initClericInv = [mail.mailcap, mail.mailarmor, mace.papermace, shield.papershield];
export const initWarriorInv = [plate.platecap, plate.platearmor, sword.papersword, shield.papershield];
export const initRogueInv = [leather.leathercap, leather.leatherarmor, [dagger.papershiv, 'mainHand'], [dagger.papershiv, 'offHand']];
