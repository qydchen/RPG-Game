...
const initHunterInv = [leather.leathercap, leather.leatherarmor, null, null, bow.paperbow];
...
const initRogueInv = [leather.leathercap, leather.leatherarmor, dagger.papershiv, dagger.papershiv];
